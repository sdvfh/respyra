...
class SymptomGenerator:
    def __init__(self, model_engine='gpt-3.5-turbo'):
        ...
        self.incomplete_prompt = "Please write a 250-word text as a psychologist with 20 years of experience in the field of mental disorders " \
...
if __name__ == '__main__':
    ...
    data_copy["Generate_Text"] = data_copy["sentence"].apply(symptom_generator.generate_symptoms)
